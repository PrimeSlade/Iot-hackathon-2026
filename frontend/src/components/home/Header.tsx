...
export const Header = () => {
  return (
    <div className="mb-8 lg:mb-12 text-center max-w-2xl mx-auto">
      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-[var(--primary-brand)] rounded-full mb-4 lg:mb-6 shadow-lg shadow-[var(--primary-brand)]/20">
